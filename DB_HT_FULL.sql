...
-- CREATE INDEX rooms_title_short_desription_idx ON rooms(title, short_desription);
...
-- visiters first name and last name validation
DELIMITER //
CREATE TRIGGER validate_visiters_first_name_last_name_insert BEFORE INSERT ON visiters
FOR EACH ROW BEGIN
